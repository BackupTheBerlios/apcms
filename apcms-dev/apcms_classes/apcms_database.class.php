...
//
// +----------------------------------------------------------------------+
// $Id: apcms_database.class.php,v 1.1 2005/10/25 23:14:42 dma147 Exp $
// +----------------------------------------------------------------------+
// $RCSfile: apcms_database.class.php,v $
// $Revision: 1.1 $
// $Date: 2005/10/25 23:14:42 $
// $Author: dma147 $
// +----------------------------------------------------------------------+
...
class APCMS_DB
    ...
    /** Der Servername oder die IP-Adresse des Datenbank-Servers (z.B. localhost) */
    var $MySQL_HostName     =      'localhost';
    
    /** Der Username des Datenbank-Users */
    var $MySQL_UserName     =      'root';
    
    /** Das Passwort des Datenbank-Users */
    var $MySQL_Password     =      '';
    
    /** Der Name der Datenbank */
    var $MySQL_Database     =      'apcms';
     ...
     * @copyright      2000-2004 by APP - Another PHP Program
     */
    function APCMS_DB($MySQL_HostName,$MySQL_UserName,&$MySQL_Password,$MySQL_Database, $persitent=0) 
        {
