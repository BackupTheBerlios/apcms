 ...
 * @subpackage includes
 * 
 * $Id: user.admin.inc.php,v 1.2 2006/05/17 11:47:35 dma147 Exp $
 */
 ...
 */
$PAGE_SUBTITLE 		= $apcms['LANGUAGE']['ADMIN_USERMANAGEMENT'];

$AOUT .= "<h3>.: ".$apcms['LANGUAGE']['ADMIN_USERMANAGEMENT']." :.</h3><br />\n";
