 ...
 * @subpackage includes
 * 
 * $Id: groups.admin.inc.php,v 1.2 2006/05/17 11:47:35 dma147 Exp $
 */
 ...
 */
$PAGE_SUBTITLE 		= $apcms['LANGUAGE']['ADMIN_GROUPMANAGEMENT'];

$AOUT .= "<h3>.: ".$apcms['LANGUAGE']['ADMIN_GROUPMANAGEMENT']." :.</h3><br />\n";
