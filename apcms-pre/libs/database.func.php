 ...
 * 
 * $Id: database.func.php,v 1.2 2006/05/17 11:47:35 dma147 Exp $
 */
...
require_once($PATH."/libs/database.class.".$SUFFIX);
$db = new BP_DB($MYSQLDATA['HOST'], $MYSQLDATA['USER'], $MYSQLDATA['PASSWD'], $MYSQLDATA['DB']);
$db->setDebug(1); 
