...
/* $Id: Smarty.class.php,v 1.1 2005/10/24 21:22:44 dma147 Exp $ */
 ...
 */
    ...
    function load_filter($type, $name)
    {
        switch ($type) {
            case 'output':
                ...
                require_once(SMARTY_DIR . 's_core' . DIRECTORY_SEPARATOR . 'core.load_plugins.php');
    ...
    $_auto_id = $this->_get_auto_id($cache_id, $compile_id);
        ...
        if (!empty($this->cache_handler_func)) {
            ...
            $_params = array('auto_base' => $this->cache_dir,
                            ...
                            'auto_id' => $_auto_id,
                            'exp_time' => $exp_time);
            require_once(SMARTY_DIR . 's_core' . DIRECTORY_SEPARATOR . 'core.rm_auto.php');
    ...
    function is_cached($tpl_file, $cache_id = null, $compile_id = null)
    {
        ...
        require_once(SMARTY_DIR . 's_core' . DIRECTORY_SEPARATOR . 'core.read_cache_file.php');
    ...
    function fetch($resource_name, $cache_id = null, $compile_id = null, $display = false)
    {
        ...
        if ($this->debugging) {
            ...
            $_params = array();
            require_once(SMARTY_DIR . 's_core' . DIRECTORY_SEPARATOR . 'core.get_microtime.php');
        ...
        if ($this->caching) {
            ...
            if (smarty_core_read_cache_file($_params, $this)) {
                ...
                if (@count($this->_cache_info['insert_tags'])) {
                    ...
                    require_once(SMARTY_DIR . 's_core' . DIRECTORY_SEPARATOR . 'core.process_cached_inserts.php');
                    $_smarty_results = smarty_core_process_cached_inserts($_params, $this);
                }
                if (@count($this->_cache_info['cache_serials'])) {
                    $_params = array('results' => $_smarty_results);
                    require_once(SMARTY_DIR . 's_core' . DIRECTORY_SEPARATOR . 'core.process_compiled_include.php');
                ...
                if ($display) {
                    if ($this->debugging)
                    {
                        ...
                        require_once(SMARTY_DIR . 's_core' . DIRECTORY_SEPARATOR . 'core.display_debug_console.php');
        ...
        if ($this->caching) {
            ...
            require_once(SMARTY_DIR . 's_core' . DIRECTORY_SEPARATOR . 'core.write_cache_file.php');
    ...
    function _get_plugin_filepath($type, $name)
    {
        ...
        require_once(SMARTY_DIR . 's_core' . DIRECTORY_SEPARATOR . 'core.assemble_plugin_filepath.php');
    ...
    function _compile_resource($resource_name, $compile_path)
    {
        ...
        if ($this->_compile_source($resource_name, $_source_content, $_compiled_content, $_cache_include)) {
            ...
            if ($this->_cache_include_info) {
                require_once(SMARTY_DIR . 's_core' . DIRECTORY_SEPARATOR . 'core.write_compiled_include.php');
            ...
            require_once(SMARTY_DIR . 's_core' . DIRECTORY_SEPARATOR . 'core.write_compiled_resource.php');
   ...
   /**
    ...
    function _fetch_resource_info(&$params)
    {
        ...
        if (!$_return) {
            ...
            require_once(SMARTY_DIR . 's_core' . DIRECTORY_SEPARATOR . 'core.is_secure.php');
        ...
        if ($params['resource_type'] == 'file') {
            if (!preg_match("/^([\/\\\\]|[a-zA-Z]:[\/\\\\])/", $params['resource_name'])) {
                ...
                foreach ($_resource_base_path as $_curr_path) {
                    ...
                    require_once(SMARTY_DIR . 's_core' . DIRECTORY_SEPARATOR . 'core.get_include_path.php');
            ...
            require_once(SMARTY_DIR . 's_core' . DIRECTORY_SEPARATOR . 'core.load_resource_plugin.php');
